	...
	if (typeof define === "function" && define.amd) {
		...
		(
				...
				function(t, e, i, r) {
					...
					var v = [ "keys", "values", "pairs", "invert", "pick",
							"omit" ];
					i.each(v, function(t) {
					...
					i
							.extend(
									...
									u,
									{
										...
										pluck : function(t) {
											return i.invoke(this.models, "get",
													t)
										},
										fetch : function(t) {
											t = t ? i.clone(t) : {};
					...
					var _ = [ "forEach", "each", "map", "collect", "reduce",
							"foldl", "inject", "reduceRight", "foldr", "find",
							"detect", "filter", "select", "reject", "every",
							"all", "some", "any", "include", "contains",
							"invoke", "max", "min", "toArray", "size", "first",
							"head", "take", "initial", "rest", "tail", "drop",
							"last", "without", "difference", "indexOf",
					...
					var x = /^(\S+)\s*(.*)$/;
					var E = [ "model", "collection", "el", "id", "attributes",
							...
							.extend(
									...
									u,
									{
										...
										getFragment : function(t, e) {
											if (t == null) {
												if (this._hasPushState
														...
														|| e) {
													t = decodeURI(this.location.pathname
										...
										start : function(t) {
											...
											var n = P.exec(navigator.userAgent
													.toLowerCase())
													&& (!s || s <= 7);
											this.root = ("/" + this.root + "/")
													.replace(O, "/");
